...
* Implantação do sistema na nuvem através do Heroku : [Link](https://peopleapi-koz.herokuapp.com/api/v1/people)

Projeto proposto por [Rodrigo Peleias](https://github.com/rpeleias/personapi_digital_innovation_one)
